                    ...
                    <div className="row">
                        ...
                        <div className="col-md-6 banner-content-left">
                            <div id="child-banner-content-left"
                                ...
                                <h2 style={{fontWeight:"bold", fontSize:"32px" ,color:"white", zIndex:"100", width:"85%"}}>
                                    We Are The Biggest IT Solution In Indonesia
                                </h2>
                                <span className="pt-3" style={{color:"white",zIndex:"100", fontSize:"20px", width:"85%"}}>
                        ...
                        <div className="col-md-3">
                            <div className="wrapper-btn-arr d-flex flex-column">
                                <div id="button-arrow-top" style={{fontSize:"20px"}}>
