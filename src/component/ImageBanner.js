                    ...
                    <div className="row">
                        ...
                        <div className="col-md-6 banner-content-left">
                            <div id="child-banner-content-left"
                                ...
                                <h2 style={{fontWeight:"bold" ,color:"white", zIndex:"100", width:"85%"}}>
                                    We Are The Biggest IT Solution In Indonesia
                                </h2>
                                <span className="pt-3" style={{color:"white",zIndex:"100", fontSize:"16px", width:"85%"}}>
